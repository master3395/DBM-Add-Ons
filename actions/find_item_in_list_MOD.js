module.exports = {
	...
	fields: ["storage", "varName", "item", "storage2", "varName2"],
	...
	<div style="padding-top: 8px;">
		Item to find:<br>
		<textarea id="item" rows="4" placeholder="Insert a variable or some text within quotation marks." style="width: 94%; font-family: monospace; white-space: nowrap; resize: none;"></textarea>
	</div><br>
	<div style="padding-top: 8px;">
		<div style="float: left; width: 35%;">
			Store In:<br>
	...
	<div>
		<p>
			Note that every list in JavaScript starts from 0!
		</p>
	</div><br>`
	},
	...
	action: function(cache) {
		...
		const item = this.eval(data.item, cache);
		var result;
